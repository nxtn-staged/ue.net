...
DEFINE_OFFSET_ACCESSOR(UObjectPropertyBase, PropertyClass);

#define TYPE_EXPORT_MANAGED_TYPE_NAME ObjectPropertyBase

TYPE_EXPORT_START

const FMemberSymbol Members[] =
{
	EXPORT_OFFSET(UObjectPropertyBase, PropertyClass, PropertyClass),
};
