...
DEFINE_OFFSET_ACCESSOR(UInterfaceProperty, InterfaceClass);

#define TYPE_EXPORT_MANAGED_TYPE_NAME InterfaceProperty

TYPE_EXPORT_START

const FMemberSymbol Members[] =
{
	EXPORT_OFFSET(UInterfaceProperty, InterfaceClass, InterfaceClass),
};
