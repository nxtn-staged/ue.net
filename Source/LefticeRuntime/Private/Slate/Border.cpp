...
#define TYPE_EXPORT_MANAGED_TYPE_NAME Border

TYPE_EXPORT_START

void EXPORT_CALL_CONV SetHorizontalAlignment(const TSharedRef<SBorder>& Border, EHorizontalAlignment HorizontalAlignment)
{
	Border->SetHAlign(HorizontalAlignment);
}

void EXPORT_CALL_CONV SetVerticalAlignment(const TSharedRef<SBorder>& Border, EVerticalAlignment VerticalAlignment)
{
