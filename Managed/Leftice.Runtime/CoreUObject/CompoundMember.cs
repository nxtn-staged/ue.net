...
namespace Unreal
{
    public class CompoundMember : Member
    {
        ...
        public string CppPrefix => Leftice.CharArrayMarshaler.ToManaged(NativeMethods.GetCppPrefix(this.pointer))!;
            ...
            where T : Member
        {
            private static readonly Dictionary<Type, ClassTypeFlags> TypeToTypeFlags = new Dictionary<Type, ClassTypeFlags>
            {
                ...
                { typeof(Method), ClassTypeFlags.Function },
                ...
                { typeof(SparseDelegateMethod), ClassTypeFlags.SparseDelegateFunction },
            ...
            public unsafe bool MoveNext()
            {
                ...
                while (this.compoundMember != IntPtr.Zero)
                {
                    ...
                    {
                        IntPtr fieldClass = Object.NativeMethods.GetClass(this.member);

                        if (Class.NativeMethods.HasAllTypeFlags(fieldClass, this.classTypeFlags) &&
                            (this.includeDeprecatedProperties ||
                            !Class.NativeMethods.HasAllTypeFlags(fieldClass, ClassTypeFlags.Property) ||
