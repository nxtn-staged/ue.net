...
namespace Unreal
{
    public class Array<T> : IDisposable, IList<T>, IReadOnlyList<T> where T : IEquatable<T>
    {
        ...
        /// </exception>
        /// <exception cref="ObjectDisposedException">The <see cref="Array{T}"/> has been disposed.</exception>
        public unsafe T this[int index]
        {
            get
            {
                ...
                return this.array->GetItemUnsafe<T>(index);
            }
            ...
            set
            {
                ...
                this.array->SetItemUnsafe(index, value);
            }
        }

        /// <summary>
        /// Gets the number of elements that the <see cref="Array{T}"/> can contain.
        /// </summary>
        /// <value>
        /// The number of elements that the <see cref="Array{T}"/> can contain.
        /// </value>
        /// <exception cref="ObjectDisposedException">The <see cref="Array{T}"/> has been disposed.</exception>
        ...
        /// <summary>
        /// Gets the number of elements contained in the <see cref="Array{T}"/>.
        /// </summary>
        /// <value>
        /// The number of elements contained in the <see cref="Array{T}"/>.
        /// </value>
        /// <exception cref="ObjectDisposedException">The <see cref="Array{T}"/> has been disposed.</exception>
        ...
        /// <summary>
        /// Searches for the specified <paramref name="item"/> and returns the zero-based index of its first occurence.
        /// </summary>
        /// <param name="item">
        /// The item to search for.
        /// </param>
        /// <returns>
        /// The zero-based index of the first occurence of <paramref name="item"/>, if found; otherwise, -1.
        /// </returns>
        /// <seealso cref="LastIndexOf"/>
        ...
        /// <summary>
        /// Inserts an item at the specified <paramref name="index"/>.
        /// </summary>
        /// <param name="index">
        ...
        /// <summary>
        /// Searches for the specified <paramref name="item"/> and returns the zero-based index of its last occurence.
        /// </summary>
        /// <param name="item">
        /// The item to search for.
        /// </param>
        /// <returns>
        /// The zero-based index of the last occurence of <paramref name="item"/>, if found; otherwise, -1.
        /// </returns>
        /// <seealso cref="IndexOf"/>
        ...
        /// </param>
        /// <returns>
        /// <see langword="true"/> is <paramref name="item"/> is successfully removed; otherwise, <see langword="false"/>.
        /// </returns>
        ...
        /// </summary>
        /// <param name="index">
        /// The <see cref="Index"/> of the element to remove.
        /// </param>
        /// <seealso cref="Remove"/>
        /// <seealso cref="RemoveRange"/>
        ...
        /// </summary>
        /// <param name="range">
        /// The <see cref="Range"/> of elements to remove.
        /// </param>
        /// <seealso cref="Remove"/>
        /// <seealso cref="RemoveAt"/>
        public void RemoveRange(Range range) => throw new NotImplementedException();
