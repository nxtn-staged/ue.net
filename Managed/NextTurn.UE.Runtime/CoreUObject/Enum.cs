...
namespace Unreal
{
    public sealed class Enum : Member
    {
        ...
        public unsafe IEnumerable<KeyValuePair<Name, long>> NamesAndValues =>
            new ScriptArray.Enumerator<KeyValuePair<Name, long>>(this.NamesPtr);
        ...
        public unsafe int GetIndexByNameString(string name)
        {
            ...
            StringMarshaler.ToNative(&nativeName, name);
